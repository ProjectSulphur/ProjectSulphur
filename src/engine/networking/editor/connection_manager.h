    ...
    namespace editor
    {
      ...
      */
      ...
      public:
        ...
        * @param[out] out_id (sulphur::engine::editor::MessageID) The memory in which the unique identifier that specifies the incoming message's type (if any) will be copied
        * @param[out] out_payload (sulphur::engine::editor::MessagePayload*) The memory in which the payload of the incoming message (if any) will be copied
        * @return (bool) True if there are unprocessed messages left
        */
        bool RetrieveNextMessage(EditorMessageID* out_id, MessagePayload* out_payload);
        /**
        * @brief Send a message to the editor
        * @param[in] id (sulphur::engine::editor::MessageID) The unique identifier that specifies the message's type
        * @param[in] payload (const sulphur::engine::editor::MessagePayload&) The payload of the message
        */
        void SendMessage(EditorMessageID id, const MessagePayload& payload);
        /**
