  ...
  namespace engine 
  {
    ...
    */
    ...
    public:
      ...
      * @param[in] hWnd (sulphur::foundation::NativeWindowHandle) The window handle to initialize this renderer with.
      ...
      */
      virtual void OnInitialize(foundation::NativeWindowHandle window_handle, const glm::ivec2& screen_size = glm::ivec2(1280, 720), bool vsync = false) = 0;
