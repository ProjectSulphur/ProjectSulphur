...
namespace sulphur
{
  namespace engine
  {
    ...
    /**
    * @class sulphur::engine::ButtonEnumWrapper : public sulphur::engine::ScriptableObject
    * @brief For exposing enumerators to the scripting environment, they need to be nested
    * @author Daniel Konings
    */
    SCRIPT_CLASS() class ButtonEnumWrapper : public ScriptableObject
    {

    public:

      SCRIPT_NAME(ButtonsEnum);

      /**
      * @brief The actual buttons enumeration
      */
      SCRIPT_ENUM() enum Buttons
      {
        kButtonUnknown = 0,
        kSpace,
        kApostrophe,
    ...
    /**
    * @brief Type definition so all code still works after wrapping
    */
    using Button = ButtonEnumWrapper::Buttons;
    ...
    //-------------------------------------------------------------------------
    using Axis = ButtonEnumWrapper::Axes;
