...
inline void SafeRelease(IUnknown* dx12Object)
{
  if (dx12Object == nullptr)
  {
    return;
  }
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
    ...
    { 
        ptr += (INT)offsetInDescriptors * descriptorIncrementSize;
        return *this;
    }
    CD3DX12_CPU_DESCRIPTOR_HANDLE& Offset(INT offsetScaledByIncrementSize) 
    { 
        ptr += (INT)offsetScaledByIncrementSize;
        return *this;
    }
